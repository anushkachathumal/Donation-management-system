...
<html>
    ...
    <body>
        ...
        $sql = "select * from physical_donation ORDER BY pd_id";
        ...
        while($row = mysqli_fetch_array($result)){
            ...
            <tr>
                ...
                <td><?php echo $contac . "-".$dcont;?></td>
                <td><?php echo $damount;?></td>
                <td><a <?php echo "href='deletephysicaldonation.php?user_id=$did'"?> class='btn btn-danger' onclick="return confirm('are you sure?')">delete</a></td>
            </tr>
